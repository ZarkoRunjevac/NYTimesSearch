...
public class SearchActivityWithGridView extends AppCompatActivity {
    ...
    public static final String TAG = SearchActivityWithGridView.class.getCanonicalName();
        ...
        searchView.setOnQueryTextListener(new OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                if(!TextUtils.isEmpty(query)){
                    SearchActivityWithGridView.this.query=query;
                    adapter.clear();
                    articles.clear();
